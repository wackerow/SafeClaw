...
echo ""
echo -e "${YELLOW}Note:${NC} Network egress restriction (HTTPS-only) is available on Linux/WSL"
echo "installers via iptables. Docker Desktop for Mac does not support host-level"
echo "iptables rules. Use Docker Desktop's network settings for additional controls."
